...
MagicItemsList["the scale"] = {
	name : "The Scale",
	source : [["HB", 0]],
	type : "shield",
	rarity : "legendary",
	magicItemTable : "F",
	description : "While holding this shield, you have a +1 bonus to AC. This bonus is in addition to the shield's normal bonus to AC. When you are hit with an attack you can use your reaction to block. Reducing the damage by 1D8. Can be used up to four times per short rest. If you use the shield to block roll a D20 to rally your party.",
	descriptionFull : "While holding this shield, you have a +1 bonus to AC. This bonus is in addition to the shield's normal bonus to AC. When you are hit with an attack you can use your reaction to block. Reducing the damage by 1D8. Can be used up to four times per short rest. If you use the shield to block roll a D20 to rally your party. 20-16: Everyone gets a D4 inspiration die for 10min. 15-11: Everyone can use a hitdice to heal instantly. 10-6: Give someone a D4 inspiration die for 10min. 5-1: Someone can use a hitdice to heal instantly",
	weight : 6,
	shieldAdd : "The Scale +1",
}